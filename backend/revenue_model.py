...
def build_revenue_model(data_dir: Path, as_of: datetime) -> Mapping[str, object]:
    ...
    performance_kpis = compute_kpis(data_dir, as_of_utc)
    finance_snapshot = compute_financial_pulse(data_dir, as_of_utc)
    workforce_projection = forecast_staffing(data_dir, as_of_utc)
